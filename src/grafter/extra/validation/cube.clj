(ns grafter.extra.validation.cube
  (:require
   ...
   [grafter.extra.validation :refer [constraint-asserter]]
...
(defn asserter [filename message]
  (constraint-asserter (query-resource filename) (str "Malformed Cube. " message)))
